    ...
    return (
      <div className="bg-slate-50 dark:bg-[#020617] min-h-screen text-slate-900 dark:text-slate-100 selection:bg-sky-500 selection:text-white flex items-center justify-center p-6 md:p-12 md:py-20 relative overflow-hidden transition-colors duration-300">
        ...
        <motion.div 
          ...
          className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/[0.05] rounded-[40px] p-8 md:p-12 shadow-2xl relative z-10 text-center"
        >
          <div className="w-16 h-16 bg-sky-600 rounded-2xl flex items-center justify-center shadow-lg shadow-sky-600/20 mx-auto mb-8">
            <Terminal className="text-white w-10 h-10 stroke-[3]" />
          </div>
          
          <h1 className="text-3xl font-black tracking-tighter text-slate-950 dark:text-white uppercase italic leading-none mb-2">
            Ativo<span className="text-sky-600">Terminal</span>
          </h1>
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-10">Controle de Frota de Pneus</p>
          
          <AuthForm />

          <div className="mt-10 flex items-center justify-center gap-2 text-slate-400 dark:text-slate-500">
            <ShieldCheck className="w-4 h-4" />
            <span className="text-[10px] font-bold uppercase tracking-widest leading-none">Criptografia Ponta-a-Ponta</span>
          </div>
        </motion.div>
      </div>
    );
